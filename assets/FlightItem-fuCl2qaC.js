...
`,sn=()=>a.jsx("nav",{children:a.jsxs(rn,{children:[a.jsx("li",{children:a.jsx(nn,{to:"/",children:"home"})}),a.jsx("li",{children:a.jsx(Tt,{href:"#",children:"tours"})}),a.jsx("li",{children:a.jsx(Tt,{href:"#",children:"about"})}),a.jsx("li",{children:a.jsx(Tt,{href:"#",children:"help"})})]})}),le=$.button`
  all: unset;
  display: flex;
  align-items: center;
...
`,ze=({isLink:t,children:e,href:r="#",...n})=>a.jsx(a.Fragment,{children:t?a.jsx(le,{as:"a",href:r,children:e}):a.jsx(le,{...n,children:e})}),Fe=Et`
  all: unset;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Ht=({isLink:t,href:e="#",icon:r,...n})=>a.jsx(a.Fragment,{children:t?a.jsx(an,{to:e,children:r}):a.jsx(on,{...n,children:r})}),cn=$.header`
  max-width: 1660px;
  position: absolute;
  top: 0;
  left: 50%;
...
`,un=$.ul`
  ...
  justify-content: center;
  gap: 0.75rem;
`,xn=()=>a.jsx(cn,{children:a.jsxs(Vr,{children:[a.jsx(en,{}),a.jsx(sn,{}),a.jsxs(un,{children:[a.jsx("li",{children:a.jsx(Ht,{isLink:!0,icon:a.jsx(Te,{}),href:"/favorites"})}),a.jsx("li",{children:a.jsx(ze,{isLink:!0,children:"sign in"})})]})]})}),fn=$.div`
  text-align: center;
  font-size: 24px;
  line-height: normal;
  width: 411px;
...
`,mn=Xe({key:"FavoriteList",default:[]}),yn=(t,e="success")=>{switch(e){case"success":Rt.success(t);break;case"error":Rt.error(t);break;case"warning":Rt.warning(t);break}},wn=({id:t,name:e,description:r,img:n,isFavorite:s,addToFavorites:o})=>{const[i,c]=Ue(mn),u=d=>{o&&o(d)},p=d=>{c(h=>h.filter(m=>m.id!==d)),yn("Successfully deleted!")};return a.jsx(fn,{children:a.jsxs("article",{children:[a.jsx(ln,{src:n,alt:e,width:411,height:296}),a.jsxs(pn,{children:[a.jsx(dn,{children:e}),a.jsx(hn,{children:r}),a.jsxs(gn,{children:[a.jsx(ze,{children:"buy"}),s?a.jsx(Ht,{icon:a.jsx(Kr,{}),onClick:()=>p(t)}):a.jsx(Ht,{icon:a.jsx(Te,{}),onClick:()=>u({id:t,name:e,description:r,img:n})})]})]})]})})};export{Vr as C,wn as F,xn as H,Ht as I,yn as a,bn as c,mn as f,$ as s};
